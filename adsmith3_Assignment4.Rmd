...
write.lp(lprec, filename = "adsmith3_Assignment4", type = "lp")
```
...
```{r}
write.lp(lprec, filename = "adsmith3_Assignment4.lp", type = "lp")
x <- read.lp("adsmith3_Assignment4.lp") # create an lp object x
x                          # display x
```
